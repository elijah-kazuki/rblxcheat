...
InstructionsSection.Name = "InstructionsSection"
InstructionsSection.Size = UDim2.new(1, 0, 0, 60)
InstructionsSection.Position = UDim2.new(0, 0, 0, 130)
InstructionsSection.BackgroundColor3 = Color3.fromRGB(25, 25, 35)
InstructionsSection.BorderSizePixel = 0
InstructionsSection.Parent = ContentArea

local InstructionsCorner = Instance.new("UICorner")
InstructionsCorner.CornerRadius = UDim.new(0, 8)
InstructionsCorner.Parent = InstructionsSection
...
InstructionsLabel.Text = "Enter target name and click START to begin following"
